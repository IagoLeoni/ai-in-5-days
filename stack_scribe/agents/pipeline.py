...
from stack_scribe.models import resolve_model
from stack_scribe.prompts import (
...
from stack_scribe.safety import build_generate_content_config
from stack_scribe.schemas import ContentPlan, DraftCritique
from stack_scribe.tools.registry import (
    MEMORY_TOOLS,
    PUBLISHING_TOOLS,
    RESEARCH_TOOLS,
    SEO_TOOLS,
...
def build_root_agent() -> LlmAgent:
    ...
    return LlmAgent(
        ...
        generate_content_config=build_generate_content_config("planner"),
        description=(
            "Editorial coordinator for StackScribe. Talks to the author, and routes "
