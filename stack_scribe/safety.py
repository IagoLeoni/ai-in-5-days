...
* **Vertex AI safety filters** (this module) run *inside the model serving stack*,
  before a token ever reaches StackScribe. They cover the harm categories Google
  classifies natively - hate speech, harassment, sexually explicit and dangerous
  content.
* **:class:`~stack_scribe.plugins.guardrail_plugin.GuardrailPlugin`** runs in our
...
from stack_scribe.models import ModelRole
