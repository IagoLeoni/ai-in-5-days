...
Every log record emitted by StackScribe is a JSON object, never a formatted
...
from stack_scribe.observability.redaction import redact_structure
...
def configure_logging(force: bool = False, stream: TextIO | None = None) -> None:
    ...
    Called once from :mod:`stack_scribe.agent` at import time, so any entry
