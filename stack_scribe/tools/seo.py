...
from stack_scribe.errors import validate_arguments
from stack_scribe.observability.logging_config import get_logger
from stack_scribe.schemas import SeoFinding, SeoReport, SeoScoreRequest, ToolStatus
...
def score_draft_seo_readiness(
    ...
    Returns:
        On success, a dict matching :class:`~stack_scribe.schemas.SeoReport`:
