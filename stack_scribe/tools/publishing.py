...
:mod:`stack_scribe.tools.registry`. :class:`stack_scribe.config.Settings`
...
from stack_scribe.config import get_settings, resolve_secret
from stack_scribe.errors import ErrorCode, tool_error, validate_arguments
...
from stack_scribe.schemas import PublishRequest, ToolStatus
...
def publish_post_to_cms(
    ...
    **This action is irreversible and externally visible.** Calling it does not
    ...
    Returns:
        A dict matching :class:`~stack_scribe.schemas.PublishReceipt`:
