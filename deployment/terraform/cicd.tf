...
resource "google_iam_workload_identity_pool" "github" {
  ...
  workload_identity_pool_id = "stackscribe-${var.environment}-gh"
  display_name              = "StackScribe GitHub Actions"
...
resource "google_service_account" "deployer" {
  ...
  project      = var.project_id
  account_id   = "stackscribe-${var.environment}-deploy"
  display_name = "StackScribe CI deployer (${var.environment})"
